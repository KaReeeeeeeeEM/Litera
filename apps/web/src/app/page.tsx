        ...
        <section className="relative isolate overflow-hidden border-b">
          ...
          <div className="mx-auto grid max-w-7xl gap-14 px-5 py-20 lg:grid-cols-[1.03fr_.97fr] lg:items-center lg:px-8 lg:py-28">
            <div className="studio-enter">
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row"><Button asChild size="lg"><Link href="/studio">Open workspace<ArrowRight data-icon="inline-end" /></Link></Button><Button asChild size="lg" variant="outline"><Link href="/features">See how it works</Link></Button></div>
